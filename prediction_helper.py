...
# Function calculate normalized risk score
...
def handle_scaling(age, df):
    ...
    if age <= 25:
        scaler_object = scaler_young_practise
    else:
        scaler_object = scaler_rest_practise
...
def predict(input_dict):
    ...
    if input_dict['Age'] <= 25:
        prediction = model_young_practise.predict(input_df)
    else:
        prediction = model_rest_practise.predict(input_df)
